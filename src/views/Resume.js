...
export default () => (
  <Resume>
    <Title>Resume</Title>
    <div className="note">
      This page can be printed on A4 paper. Or you can{" "}
      <a
        target="_blank"
        rel="noopener noreferrer"
        href="http://static.bhashkar.me/resume.pdf"
      >
        grab the PDF here
      </a>.
    </div>
      ...
      <div>
        <div className="left">
          <div className="area summary">
            <h2>
              Product-focused generalist software engineer with an eye for
              detail.
            </h2>
            <div>
          ...
          <div className="area education">
            ...
            <div className="section">
              ...
              <div className="course">
                B. Tech. in Information Technology<span className="duration">
                  2005-2009
                </span>
              </div>
              <div className="description">
          ...
          <div className="area experience">
            ...
            <div className="section">
              <div className="position">
                Frontend Engineer<span className="duration">
                  Jun 2016-Present
                </span>
              </div>
              <div className="company">
                Smaato<span className="location">Hamburg, DE</span>
              </div>
            ...
            <div className="section">
              <div className="position">
                Lead Engineer<span className="duration">Aug 2015-Mar 2016</span>
              </div>
              <div className="company">
                MobStac<span className="location">Bengaluru, IN</span>
              </div>
              <div className="projects">
                <div className="section">
            ...
            <div className="section">
              <div className="position">
                Senior Engineer<span className="duration">
                  Oct 2013-Jul 2015
                </span>
              </div>
              <div className="company">
            ...
            <div className="section">
              <div className="position">
                Core Platform Engineer<span className="duration">
                  Feb 2010-Sep 2013
                </span>
              </div>
              <div className="company">
